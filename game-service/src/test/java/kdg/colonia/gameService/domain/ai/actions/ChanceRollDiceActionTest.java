...
@SpringBootTest
class ChanceRollDiceActionTest {
    ...
    public void rollDice() {
        Action action = new ChanceRollDiceAction(7, currentPlayer.getPlayerId(),0.5, gameLogicService);
        action.performAction(game);

        assertFalse(currentPlayer.getRemainingActions().contains(PlayerAction.ROLL));
    }
}