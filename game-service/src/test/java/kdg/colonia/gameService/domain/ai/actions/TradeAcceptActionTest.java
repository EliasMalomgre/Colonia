...
class TradeAcceptActionTest {
    ...
    public void AcceptTrade() {
        ...
        Action action = new TradeAcceptAction(game.getTradeRequest().getReceivingPlayer(), tradeService);

        action.performAction(game);

        assertNull(game.getTradeRequest());
        assertEquals(2, currentPlayer.getGrain());
