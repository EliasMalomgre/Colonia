 ...
 */
@AllArgsConstructor
public class UseDCKnightAction implements Action {
    ...
    public Game performAction(Game game) {
        ...
        gameLogicService.playCard(game, player, ProgressCardType.KNIGHT);
        gameLogicService.moveRobber(game, player, coordinate);
    ...
    public String toString() {
        return this.getClass().getSimpleName() + " at " + coordinate;
    }
}
